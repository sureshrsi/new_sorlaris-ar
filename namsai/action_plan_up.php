...
$dist_name = 'Namsai ';
$query = "SELECT namsaicircle.cir_name,namsaicircle.gid,ST_Extent(namsaicircle.geom) ext
FROM public.namsaicircle where namsaicircle.dist_name = '$dist_name'
group by namsaicircle.gid ,namsaicircle.cir_name order by namsaicircle.cir_name;";
...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <div class="header_toggle parent">
            ...
            <div class="child ">
                <h5 class="pro-title" style="margin-left:20px;margin-top:1rem;color: #3C457C;font-weight: 600;letter-spacing: 2px;line-height: 18px;">ACTION PLAN <br> <span style="margin: 0px;padding: 0px;font-size : 12px;color:#6C6D71;">NAMSAI DISTRICT</span>
                </h5>
            </div>
        </div>
      ...
      <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12" >
                                <img style="margin-top: 18px;height: 70px;width:70px;" class="card-img logo img-fluid mx-auto d-block" src="../nri_img/arplogo.jpg" alt="Card image">
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;">
                                ...
                                <h6>Plot #7 Type-I IE Kukatpally, Hyderabad, 500072 TS India</h6>
                                <p style="padding: 0px;margin:0px"><a href="https://www.rsigeotech.com" style="color:#4B578C">www.rsigeotech.com</a>| info@rsigeotech.com 
                                    </p>
