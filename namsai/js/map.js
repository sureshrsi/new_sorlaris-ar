...
var dist_layer = '';
var grid_layer = '';
var namsai_drainage_l = '';
var namsai_drainage_p = '';
...
var view = new ol.View({
    center: ol.proj.transform([95.87135,27.66894], 'EPSG:4326', 'EPSG:3857'),
    zoom: 10.5,
    // minZoom: 10.5,
    maxZoom: 18,
  });
      ...
      new ol.layer.Tile(
        ...
        new ol.layer.Tile(
          ...
          new ol.layer.Tile(
            {
              title: "Contour",
              name: 'APWS:tawang_contour_updated',
              baseLayer: false,
              source: grid_layer = new ol.source.TileWMS({
                url: base_url + '/wms',
                params: { 'LAYERS': 'APWS:namsai_contour_update', 'TILED': true },
                // format : new ol.format.GeoJSON,
                serverType: 'geoserver',
                // Countries have transparency, so do not fade tiles:
                transition: 0
        ...
        new ol.layer.Tile(
          ...
          baseLayer: false,
            source: action_plan = new ol.source.TileWMS({
              url: base_url + '/wms',
              params: {'LAYERS': 'APWS:namsai_action_plan_01042024', 'TILED': true},
             // format : new ol.format.GeoJSON,
              serverType: 'geoserver',
              // Countries have transparency, so do not fade tiles:
              transition: 0
        ...
        new ol.layer.Tile(
          ...
          baseLayer: false,
            source: cropsuitability = new ol.source.TileWMS({
              url: base_url + '/wms',
              params: {'LAYERS': 'APWS:namsai_crop_suitability_01042024', 'TILED': true},
             // format : new ol.format.GeoJSON,
              serverType: 'geoserver',
              // Countries have transparency, so do not fade tiles:
              transition: 0
          ...
          new ol.layer.Tile(
            ...
            baseLayer: false,
              source: capability = new ol.source.TileWMS({
                url: base_url + '/wms',
                params: {'LAYERS': 'APWS:namsai_land_capability', 'TILED': true},
               // format : new ol.format.GeoJSON,
                serverType: 'geoserver',
                // Countries have transparency, so do not fade tiles:
                transition: 0
             ...
             new ol.layer.Tile(
              ...
              baseLayer: false,
                source: irrigability = new ol.source.TileWMS({
                  url: base_url + '/wms',
                  params: {'LAYERS': 'APWS:namsai_land_irrigability', 'TILED': true},
                 // format : new ol.format.GeoJSON,
                  serverType: 'geoserver',
                  // Countries have transparency, so do not fade tiles:
                  transition: 0
            ...
            new ol.layer.Tile(
              ...
              baseLayer: false,
                source: degradation = new ol.source.TileWMS({
                  url: base_url + '/wms',
                  params: {'LAYERS': 'APWS:namsai_land_degradation', 'TILED': true},
                 // format : new ol.format.GeoJSON,
                  serverType: 'geoserver',
                  // Countries have transparency, so do not fade tiles:
                  transition: 0
                      ...
                      new ol.layer.Tile(
                        ...
                        name : 'namsai_hgeom',
                          ...
                          source: hgeom = new ol.source.TileWMS({
                            url: base_url + '/wms',
                            crossOrigin: null,
                            params: {'LAYERS': 'APWS:namsai_hgeom', 'TILED': true},
                            serverType: 'geoserver',
                            // Countries have transparency, so do not fade tiles:
                            transition: 0
                        }),
                      ...
                      new ol.layer.Tile(
                        ...
                        name : 'namsai_lineament',
                          ...
                          source: lineament = new ol.source.TileWMS({
                            url: base_url + '/wms',
                            crossOrigin: null,
                            params: {'LAYERS': 'APWS:namsai_lineament', 'TILED': true},
                            serverType: 'geoserver',
                            // Countries have transparency, so do not fade tiles:
                            transition: 0
                        }),
                      ...
                      new ol.layer.Tile(
                        ...
                        baseLayer: false,
                          source: slope = new ol.source.TileWMS({
                            url: base_url + '/wms',
                            params: {'LAYERS': 'APWS:namsai_slope_new', 'TILED': true},
                           // format : new ol.format.GeoJSON,
                            serverType: 'geoserver',
                            // Countries have transparency, so do not fade tiles:
                            transition: 0
                      ...
                      new ol.layer.Tile(
                        ...
                        name : 'namsai_lulc_1_new',
                          ...
                          source: lulc = new ol.source.TileWMS({
                            url: base_url + '/wms',
                            crossOrigin: null,
                            params: {'LAYERS': 'APWS:namsai_lulc_1_new', 'TILED': true},
                            serverType: 'geoserver',
                            // Countries have transparency, so do not fade tiles:
                            transition: 0
                        }),
                          visible: true
                              ...
                              new ol.layer.Tile(
                                ...
                                baseLayer: false,
                                  source: wshed = new ol.source.TileWMS({
                                    url: base_url + '/wms',
                                    params: {'LAYERS': 'APWS:namsai_watershed_union', 'TILED': true},
                                   // format : new ol.format.GeoJSON,
                                    serverType: 'geoserver',
                                    // Countries have transparency, so do not fade tiles:
                                    transition: 0
                                ...
                                new ol.layer.Tile(
                                  ...
                                  name : 'namsai_drainp',
                                    baseLayer: false,
                                    source: 	namsai_drainage_p = new ol.source.TileWMS({
                                      url: base_url + '/wms',
                                      params: {'LAYERS': 'APWS:namsai_drainp', 'TILED': true},
                                    // format : new ol.format.GeoJSON,
                                      serverType: 'geoserver',
                                      // Countries have transparency, so do not fade tiles:
                                      transition: 0
                                  ...
                                  new ol.layer.Tile(
                                    ...
                                    name : 'namsai_drainl_new',
                                      baseLayer: false,
                                      source: 	namsai_drainage_l= new ol.source.TileWMS({
                                        url: base_url + '/wms',
                                        params: {'LAYERS': 'APWS:namsai_drainl_new', 'TILED': true},
                                      // format : new ol.format.GeoJSON,
                                        serverType: 'geoserver',
                                        // Countries have transparency, so do not fade tiles:
                                        transition: 0
                              ...
                              new ol.layer.Tile(
                                ...
                                baseLayer: false,
                                  source: circle_layer = new ol.source.TileWMS({
                                    url: base_url + '/wms',
                                    params: {'LAYERS': 'APWS:circle_boundary', 'TILED': true},
                                   // format : new ol.format.GeoJSON,
                                    serverType: 'geoserver',
                                    // Countries have transparency, so do not fade tiles:
                                    transition: 0
                              ...
                              new ol.layer.Tile(
                                ...
                                baseLayer: false,
                                  source: grid_layer = new ol.source.TileWMS({
                                    url: base_url + '/wms',
                                    params: {'LAYERS': 'APWS:namsai_grid_10k', 'TILED': true},
                                   // format : new ol.format.GeoJSON,
                                    serverType: 'geoserver',
                                    // Countries have transparency, so do not fade tiles:
                                    transition: 0
...
function getAPReport() {
  ...
  postAPData("../namsai/apreport.php", data, "POST")
}
  ...
  $("#sidebarcontent_mobile").empty();
    ...
    if (lulc_url) {
      $.ajax({
        ...
        success: function (lulc_data, status, jqXHR) {
          if (lulc_data.features.length == 1) {
            $("#sidebarcontent_mobile").append("<div>" + "<h6 style='paddding:0px;margin:0px'>Land Use Land Cover </h6>" + "</div><br>");
            //$("#popup-content").append("<div> <b> " + layer_title +" </b></div><br>");
            for (index = 0; index < lulc_data.features.length; index++) {
...
function convertDMSToDecimcal() {
  ...
  if (arraydms.length==2){
    ...
    map.getView().fit(ol.proj.transformExtent([96.01,27.72,96.01,27.72], 'EPSG:4326', map.getView().getProjection()));
    map.getView().setZoom(11.5);
  }
  else {
...
function getVisibleLayerslist() {
  ...
  all_layers.forEach(layer => {
    ...
    if ((layervisability == true) && (layer.getProperties().name == 'namsai_lulc_1_new' ||
      layer.getProperties().name == 'namsai_slope_new' ||
      layer.getProperties().name == 'namsai_lineament' ||
      layer.getProperties().name == 'namsai_hgeom' ||
      layer.getProperties().name == 'soil_1_new' ||
      layer.getProperties().name == 'namsai_land_degradation' ||
      layer.getProperties().name == 'namsai_land_irrigability' ||
      layer.getProperties().name == 'namsai_land_capability' ||
      layer.getProperties().name == 'namsai_crop_suitability' ||
      layer.getProperties().name == 'namsai_land_and_water_action_plan')) {
  ...
  if (toplayer == 'namsai_lulc_1_new') {
    $('#lulc').focus();
    document.getElementById("lulc").click();
  }
  else if (toplayer == 'namsai_hgeom') {
    $('#hgeom').focus();
    document.getElementById("hgeom").click();
  }
  else if (toplayer == 'namsai_slope_new') {
    $('#slope_id').focus();
    document.getElementById("slope_id").click();
  }
  else if (toplayer == 'soil_1_new') {
    $('#so').focus();
