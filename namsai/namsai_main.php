      ...
      <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <h5 class="card-title">Arunachal Pradesh Space Application Centre</h5>
                                ...
                                <p style="padding: 0px;margin:0px">website: <a style="padding: 0px;margin:0px" href="https://www.srsac.arunachal.gov.in" style="color:#4B578C" target="_blank">www.srsac.arunachal.gov.in</a></p>
                                <!-- <p>Phone Number:----------</p> -->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;">
                                ...
                                <p style="padding: 0px;margin:0px"><a href="https://www.rsigeotech.com" style="color:#4B578C" target="_blank">www.rsigeotech.com</a>| info@rsigeotech.com 
                                    </p>
