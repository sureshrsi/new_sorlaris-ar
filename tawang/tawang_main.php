...
<body id="body-pd">
    <header class="header" id="header">
        <!-- <div class="menu-icon-box" onclick="openMobileSidebar()">
        ...
        <div class="header_toggle parent">
            ...
            <div class="child ">
                <h6 class="pro-title">SOIL AND LAND RESOURCES INFORMATION SYSTEM<br>ARUNACHAL PRADESH
                </h6>
            </div>
        </div>
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav" id="nav-items">
            <div style="width: 205px;"> <a style="text-decoration: none;" href="http://solaris-ar.com/index.html" class="nav_logo"> <img src="../img/SOLARISLogov.png" alt="" height="45px" width="180x" style="margin: 0px 0px 5px 14px;">
                ...
                <div class="nav_list" id="list-navbar">
                    <!-- container for cricle selection -->
                    <div class="container" id="cricle_container" style="text-align: center;justify-content: center;">
                        <div class="row">
                            <h6 style="margin :12px 0px 5px 0px;font-size: 13px;font-weight: 600;text-align: center;letter-spacing: 4px;"><?php echo strtoupper($dist_name) ?><br> DISTRICT</h6>
    ...
    <div class="modal bd-example-modal-lg fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1" style="margin-left: 327px;">Feedback</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body" style="display: flex;justify-content: center; align-items: center;font-size: 12px;">
                    <form class="form-container" style="width: 400px;justify-content: center;align-items: center;text-align: center;">
                        <div class="form-row">
    ...
    <div class="modal bd-example-modal-lg fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="text-align: center;margin-left: 328px;" id="exampleModalLabel2">Contact Us</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <img style="margin-top: 0px;height: 70px;width:70px;" class="card-img logo img-fluid mx-auto d-block" src="../img/arplogo.jpg" alt="Card image">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;">
                                <h5 class="card-title" style="margin-bottom: 0px;">Arunachal Pradesh Space Application Centre</h5>
                                ...
                                <p style="padding: 0px;margin:0px;font-size:11px;">Address - Civil Secretariat, ITANAGAR - 791111 , Arunachal Pradesh</p>
                                <p style="padding: 0px;margin:0px">website: <a style="padding: 0px;margin:0px;color:#4B578C;text-decoration:none" href="https://www.srsac.arunachal.gov.in" target="_blank">www.srsac.arunachal.gov.in</a></p>
                                <!-- <p>Phone Number:----------</p> -->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;">
                                ...
                                <h6 style="margin-bottom: 0px;font-size: 11px;">Plot #7 Type-I IE Kukatpally, Hyderabad, 500072 TS India</h6>
                                <p style="padding: 0px;margin:0px;"><a href="https://www.rsigeotech.com" style="color:#4B578C;text-decoration:none" target="_blank">www.rsigeotech.com</a>| info@rsigeotech.com
                                </p>
                                <p style="margin-bottom: 0px;">+91 40 4017 5518 | +91 40 2307 8566</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        // let menu_icon = document.querySelector(".menu-icon-box");
        // let l_navbar = document.querySelector("l-navbar");

        // menu_icon.onclick = function() {
        //     if (window.matchMedia("(max-height: 480px)") && document.getElementById('nav-bar').style.display == 'none') {
        //         document.getElementById('nav-bar').style.display = "block";
        //         document.getElementById('nav-bar').style.width = "100%";
        //         document.getElementById('nav-bar').style.marginTop = "70px";
        //         document.getElementById('nav-items').style.alignItems = "center";

        //         // menu_icon.classList.toggle("active");
        //         // l_navbar.classList.toggle("active");
        //     } else {
