...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <div class="header_toggle parent">
            ...
            <div class="child ">
                <h5 class="pro-title" style="margin-left:20px;margin-top:1rem;color: #3C457C;font-weight: 600;letter-spacing: 2px;line-height: 18px;">BASE MAP <br> <span style="margin: 0px;padding: 0px;font-size : 12px;color:#6C6D71">TAWANG DISTRICT</span>
                </h5>
            </div>
        </div>
    ...
    <!-- <div id="mySidebarRight" class="container sidebarright" style="display: none;">
...
<div class="modal bd-example-modal-lg fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
      ...
      <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12" >
                                <img style="margin-top: 0px;height: 70px;width:70px;" class="card-img logo img-fluid mx-auto d-block" src="../nri_img/arplogo.jpg" alt="Card image">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <h5 class="card-title" style="margin-bottom: 0px;">Arunachal Pradesh Space Application Centre</h5>
                                ...
                                <p style="padding: 0px;margin:0px">website: <a style="padding: 0px;margin:0px;color:#4B578C;text-decoration:none" href="https://www.srsac.arunachal.gov.in">www.srsac.arunachal.gov.in</a></p>
                                <!-- <p>Phone Number:----------</p> -->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;">
                                ...
                                <p style="padding: 0px;margin:0px;"><a href="https://www.rsigeotech.com" style="color:#4B578C;text-decoration:none">www.rsigeotech.com</a>| info@rsigeotech.com 
                                    </p>
    ...
    <script src="./js/basemap_up.js"></script>
    <!-- <script src="./js/map1.js"></script> -->
    <script src="../js/all_up_layers.js"></script>
