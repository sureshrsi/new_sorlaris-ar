        ...
        new ol.layer.Tile(
          {
            ...
            name: 'tawang_drainp',
            baseLayer: false,
            source: tawang_drainage_source = new ol.source.TileWMS({
              url: base_url + '/wms',
    ...
    new ol.layer.Tile(
      {
        ...
        baseLayer: false,
        source: circle_source = new ol.source.TileWMS({
          url: base_url + '/wms',
                           ...
                           // console.log(k , data1.features[index].properties[k]);
                            ...
                            Object.entries(cropsuitabilitylabels).forEach(([key, value]) => 
                            {
                              ...
                              if (key == k )
                              {
                                ...
                                $("#popup-content").append("<div style='font-size:12px;padding-bottom: 10px;'>" + "<strong>" + value +"</strong>" + " : " + data1.features[index].properties[k] +"</div><br>");
                              }
...
function getVisibleLayerslist() {
  ...
  all_layers.forEach(layer => {
    ...
    if ((layervisability == true)  && (layer.getProperties().name == 'tawang_crop_suitability_01022024')) {
