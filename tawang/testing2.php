...
// $dist_name=$_POST["dist_tw"];
// $dist_name = 'Tawang';
// $query = "SELECT tawang_circle_boundary.cir_name,tawang_circle_boundary.gid,ST_Extent(tawang_circle_boundary.the_geom) ext
// FROM tawang_circle_boundary where tawang_circle_boundary.dist_name = '$dist_name'
// group by tawang_circle_boundary.gid ,tawang_circle_boundary.cir_name order by tawang_circle_boundary.cir_name;";
...
$query = "select dist,gid,ST_Extent(dist.geom) ext from dist group by gid";
...
<!doctype html>
<html lang="en">
<!-- <allow-navigation href="https://solaris-ar.com/" />
...
<body id="body-pd">
    <header class="header" id="header">
        <div class="header_toggle parent">
            ...
            <div class="child ">
                <h6 style="margin-left:20px;margin-top:1rem;color: #3C457C;font-weight: 600;">SOIL AND LAND RESOURCES INFORMATION SYSTEM<br>ARUNACHAL PRADESH
                </h6>
            </div>
        </div>
        ...
        <div class="header_img">
            ...
            <div class="search">
                ...
                <button id="popupButton" type="button" class="btn btn-light" onclick="openToggle()"></button>
            </div>
            ...
            <img src="../img/apsac.png" alt="" style="height:58px;width:60px">
            <img src="../img/Arunachal_Pradesh_Seal.png" alt="" style="width :85px">
            <!-- <a href="./index_p.php">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div style="width: 205px;"> <a style="text-decoration: none;" href="#" class="nav_logo"> <img src="../img/SOLARISLogov.png" alt="" height="45px" width="180x" style="margin: 0px 0px 5px 14px;">
                ...
                <div class="nav_list">
                    ...
                    <div class="container" id="cricle_container">
                        <div class="row" style="width: 219px;">
                            <!-- <h6 style="margin :12px 0px 5px 19px;font-size: 13px;font-weight: 600;"><?php echo strtoupper($dist_name) ?> DISTRICT</h6> -->
                            <select name="district" id="district1" class="form-select form-select-sm mb-2" aria-label=".form-select-sm example" style="width: 190px;padding: 0px 0px 0px 5px;margin:11px 0px 13px -5px;" onChange="getCircle(this.value),getZoomto(this.value);">
                            ...
                            <div class="row" id="content_btn">
                                <div class="btn-group" role="group" aria-label="Basic radio toggle button group" style="padding: 0px;">
                                    ...
                                    <label class="btn btn1 btn-outline-primary" for="btnradio1" autofocus>GridNo</label>

                                    <input type="radio" class="btn-check btn-select1" name="btnradio4" id="btnradio2" autocomplete="off">
                                    <label class="btn btn1 btn-outline-primary" for="btnradio2">Village</label>

                                    <input type="radio" class="btn-check btn-select1" name="btnradio4" id="btnradio3" autocomplete="off">
                                    <label class="btn btn1 btn-outline-primary" for="btnradio3">Watershed</label>
                                </div>
                            </div>
                            <div class="row content_row">
                                <div class="content">
                                    <select name="grid_id" id="grid1" class="form-select form-select-sm mb-3" aria-label=".form-select-sm example" onChange="getZoomto(this.value),buttonEnable1();">
                    ...
                    <div class="container" id="layer-control">
                        ...
                        <div class="row">
                            <h6 style="margin: 6px 0px 6px 24px;font-size: 13px;">LAYER CONTROL</h6>
                            <hr style="margin : 0px 0px 0px 5px;height : 2px;width: 167px;">
                            <div class="accordion">
                                <div class="accordion-item active">
                                    <div class="accordion-header">
                                        <span class="icon">-</span>BASE LAYERS
                                    </div>
                                    <div class="accordion-content">
                                        <div style="display: flex;">
                                            <label for="layer1">Layer1</label>
                                            <label class="const">
                                                <input type="checkbox" value="tawang_circle_boundary">
                                       ...
                                       <div style="display: flex;">
                                            <label for="layer1">Layer1</label>
                                            <label class="const">
                                                <input type="checkbox" value="tawang_crop_suitability1">
                                                <div class="switch"></div>
                                            </label>
                                        </div>
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-header">
                                        <span class="icon">+</span>THEMATIC LAYERS
                                    </div>
                                    <div class="accordion-content">
                    ...
                    <div class="container" id="legendtitle">
                        <div class="row">
                            ...
                            <button onclick="show_hide_legend()" type="button" id="legend_btn" class="btn btn-sm" style="background-color: transparent;color:black">
                                <h6 style="margin: 8px 0px 6px 48px;font-size: 13px;">☰ LEGEND</h6>
                            </button>
                            <hr style="margin : 0px 0px 0px 15px;height : 2px;width: 150px;">
                        </div>
                    </div>
                    ...
                    <div class="container" id="info_scroll">
                        <!-- <div class="row"> -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" style="font-size: 12px;">
                    <p class="paragraph">
                        Integrated Land and Soil Resources Information System (ILSRIS) is a user-friendly web and mobile application which is developed under Natural Resources Inventory for Micro Level Agricultural Planning (NRIMAP) to provide highly intuitive and effective recommendation system which has accurate information and reports for multiple players across the Agriculture Ecosystem.
                    </p>
                    <br style="content: '';margin: 2em; display: block; font-size: 30%;" />
                    <p class="paragraph">
                        Natural Resources Inventory for Micro Level Agricultural Planning (under Comprehensive Agriculture Management Program NRIMAP) is a pilot project implemented in three districts namely Namsai, Lower Subansiri and Tawang selected from three elevation regions of Arunachal Pradesh State. ILSRIS is designed, developed and implemented by Remote Sensing Instruments LLP (RSI LLP), Hyderabad for Arunachal Pradesh Space Applications Centre, Department of Science and Technology, Govt. of Arunachal Pradesh.
                    </p>
                    <br style="content: '';margin: 2em; display: block; font-size: 30%;" />
                    <p class="paragraph">
                        ILSRIS is developed using State-of-the-art Geospatial Technologies involving Remote Sensing, GIS, Photogrammetry and other GIS Technologies. It is implemented using high-resolution satellite data from national and international satellite data providers.
                    </p>
                    <br style="content: '';margin: 2em; display: block; font-size: 30%;" />
                    <p class="paragraph">
                        ILSRIS also offers a broad spectrum of maps and information like Base Map, Thematic Maps like Agriculture and Other Land Use Land Cover, Hydro-geomorphology, Slope, Soil and Soil Derivative Maps, Action Plan for Land and Water Resources Development and Crop Suitability Maps on 1:10,000 scale. A Comprehensive and easy to access soil health report, crop suitability and action plan for land and water resources development is available for each land parcel and can be downloaded on both web and mobile applications.
                    </p>
                    <br style="content: '';margin: 2em; display: block; font-size: 30%;" />
                    <p class="paragraph">
                        This Highly effective ILSRIS is useful for multiple players across agriculture ecosystem and is a strong recommendation system for farmers which will in turn increase their economic growth by suggesting them to cultivate suitable crops with utilizing available nutrients and natural resources.
                    </p>
                </div>
    ...
    <div class="modal bd-example-modal-lg fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="text-align: center;" id="exampleModalLabel2">Contact Us</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body" style="font-size: 12px;">
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <img style="margin-top: 20px;height: 45px;width:45px;" class="card-img logo img-fluid mx-auto d-block" src="../nri_img/arplogo.jpg" alt="Card image">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;">
                                ...
                                <p style="padding: 0px;margin:0px">website: <a style="padding: 0px;margin:0px" href="https://www.srsac.arunachal.gov.in" style="color:#4B578C">www.srsac.arunachal.gov.in</a></p>
                                <!-- <p>Phone Number:----------</p> -->
                            </div>
                        </div>
                        <div class="row" style="margin-top: 2%;">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <img class="card-img logo img-fluid mx-auto d-block" style="height: 50px;width: 267px;" src="../nri_img/RSILLP.jpg" alt="Card image">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;">
                                <!-- <h5>Remote Sensing Instruments LLP (RSI LLP)</h5> -->
                                <p>Plot #7 Type-I IE Kukatpally, Hyderabad, 500072 TS India</p>
                                <p><a href="https://www.rsigeotech.com" style="color:#4B578C">www.rsigeotech.com</a>| info@rsigeotech.com
                                </p>
    ...
    <footer class="" style="margin: 0px;padding: 0px;height: 0px;">
        ...
        <p class="text-center text-muted" style="margin-top: 9px;color: black;font-size:12px;padding-bottom: 7px;">Designed and Developed by Remote Sensing
            Instruments LLP <a href="https://rsigeotech.com/" style="color: #3C457C;text-decoration: none;">(RSI LLP)</a> for Arunachal Pradesh Space Application Centre <a href="https://www.srsac.arunachal.gov.in/" style="color: #3C457C;text-decoration: none;">(APSAC)</a>, Government of Arunachal Pradesh,
            Copyrights © 2024</p>
    </footer>
