...
$query = "SELECT ST_Extent(tawang_soil.the_geom) coordinates FROM public.tawang_soil where tawang_soil.id ='$id';";
...
$pointquery = "SELECT ST_ASTEXT(st_centroid(the_geom)) point_coordinates FROM public.tawang_soil where tawang_soil.id ='$id';";
...
while ($row_point = pg_fetch_assoc($current_row)) {
 ...
 avl_b_ppm,
 avl_mo_ppm 
 from public.tw_report where soil_code='$soil_code';";
...
<div class="container">
    ...
    <div class="print-button">
		...
		<button style="background-color:  #3C457C;color:white" type="button" onclick="location.href='tawang_main.php'" class="print-buttons btn btn-success">Back</button>
	</div>
    ...
    <script>
			...
			var soil=new ol.layer.Tile(
						{	title: "Soil Information",
							...
							url: base_url + '/wms',
							params: {'LAYERS': 'APWS:tawang_soil', 'TILED': true},
