      ...
      new ol.layer.Tile(
        ...
        new ol.layer.Tile(
          ...
          new ol.layer.Tile(
            {
              title: "Contour",
              name: 'APWS:lower_subansiri_countour_updated',
              baseLayer: false,
              source: grid_layer = new ol.source.TileWMS({
                url: base_url + '/wms',
                params: { 'LAYERS': 'APWS:lower_subansiri_countour_updated', 'TILED': true },
                // format : new ol.format.GeoJSON,
                serverType: 'geoserver',
                // Countries have transparency, so do not fade tiles:
                transition: 0
        ...
        new ol.layer.Tile(
          ...
          baseLayer: false,
            source: action_plan = new ol.source.TileWMS({
              url: base_url + '/wms',
              params: {'LAYERS': 'APWS:lower_subansiri_action_plan_test_14022024', 'TILED': true},
             // format : new ol.format.GeoJSON,
              serverType: 'geoserver',
              // Countries have transparency, so do not fade tiles:
              transition: 0
        ...
        new ol.layer.Tile(
          ...
          baseLayer: false,
            source: cropsuitability = new ol.source.TileWMS({
              url: base_url + '/wms',
              params: {'LAYERS': 'APWS:lower_subansiri_crop_suitability_updated_01022024', 'TILED': true},
             // format : new ol.format.GeoJSON,
              serverType: 'geoserver',
              // Countries have transparency, so do not fade tiles:
              transition: 0
          ...
          new ol.layer.Tile(
            ...
            baseLayer: false,
              source: capability = new ol.source.TileWMS({
                url: base_url + '/wms',
                params: {'LAYERS': 'APWS:lower_subansiri_land_capability_01022024', 'TILED': true},
               // format : new ol.format.GeoJSON,
                serverType: 'geoserver',
                // Countries have transparency, so do not fade tiles:
                transition: 0
             ...
             new ol.layer.Tile(
              ...
              name : 'lower_subansiri_land_irrigability_01022024',
              baseLayer: false,
                source: irrigability = new ol.source.TileWMS({
                  url: base_url + '/wms',
                  params: {'LAYERS': 'APWS:lower_subansiri_land_irrigability_01022024', 'TILED': true},
                 // format : new ol.format.GeoJSON,
                  serverType: 'geoserver',
                  // Countries have transparency, so do not fade tiles:
                  transition: 0
            ...
            new ol.layer.Tile(
              ...
              baseLayer: false,
                source: degradation = new ol.source.TileWMS({
                  url: base_url + '/wms',
                  params: {'LAYERS': 'APWS:lower_subansiri_land_degradation', 'TILED': true},
                 // format : new ol.format.GeoJSON,
                  serverType: 'geoserver',
                  // Countries have transparency, so do not fade tiles:
                  transition: 0
                    ...
                    new ol.layer.Tile(
                      ...
                      name : 'lower_subansiri_soil',
                        ...
                        source: soil = new ol.source.TileWMS({
                          url: base_url + '/wms',
                          crossOrigin: null,
                          params: {'LAYERS': 'APWS:lower_subansiri_soil', 'TILED': true},
                          serverType: 'geoserver',
                          // Countries have transparency, so do not fade tiles:
                          transition: 0
                      }),
                      ...
                      new ol.layer.Tile(
                        ...
                        name : 'lower_subansiri_hgeom1_01022024',
                          ...
                          source: hgeom = new ol.source.TileWMS({
                            url: base_url + '/wms',
                            crossOrigin: null,
                            params: {'LAYERS': 'APWS:lower_subansiri_hgeom1_01022024', 'TILED': true},
                            serverType: 'geoserver',
                            // Countries have transparency, so do not fade tiles:
                            transition: 0
                        }),
                      ...
                      new ol.layer.Tile(
                        ...
                        name : 'lower_subansiri_lineament',
                          ...
                          source: lineament = new ol.source.TileWMS({
                            url: base_url + '/wms',
                            crossOrigin: null,
                            params: {'LAYERS': 'APWS:lower_subansiri_lineament', 'TILED': true},
                            serverType: 'geoserver',
                            // Countries have transparency, so do not fade tiles:
                            transition: 0
                        }),
                      ...
                      new ol.layer.Tile(
                        ...
                        baseLayer: false,
                          source: slope = new ol.source.TileWMS({
                            url: base_url + '/wms',
                            params: {'LAYERS': 'APWS:lower_subansiri_slope', 'TILED': true},
                           // format : new ol.format.GeoJSON,
                            serverType: 'geoserver',
                            // Countries have transparency, so do not fade tiles:
                            transition: 0
                      ...
                      new ol.layer.Tile(
                        ...
                        name : 'lower_subansiri_lulc',
                          ...
                          source: lulc = new ol.source.TileWMS({
                            url: base_url + '/wms',
                            crossOrigin: null,
                            params: {'LAYERS': 'APWS:lower_subansiri_lulc', 'TILED': true},
                            serverType: 'geoserver',
                            // Countries have transparency, so do not fade tiles:
                            transition: 0
                        }),
                        ...
                        new ol.layer.Tile(
                          ...
                          name : 'lower_subansiri_drainp',
                            baseLayer: false,
                            source: drainage_p = new ol.source.TileWMS({
                              url: base_url + '/wms',
                              params: {'LAYERS': 'APWS:lower_subansiri_drainp', 'TILED': true},
                            // format : new ol.format.GeoJSON,
                              serverType: 'geoserver',
                              // Countries have transparency, so do not fade tiles:
                              transition: 0
                        ...
                        new ol.layer.Tile(
                          ...
                          name : 'lower_subansiri_drainl',
                            baseLayer: false,
                            source: drainage_l = new ol.source.TileWMS({
                              url: base_url + '/wms',
                              params: {'LAYERS': 'APWS:lower_subansiri_drainl', 'TILED': true},
                            // format : new ol.format.GeoJSON,
                              serverType: 'geoserver',
                              // Countries have transparency, so do not fade tiles:
                              transition: 0
                        ...
                        new ol.layer.Tile(
                              ...
                              name : 'Lowersubansiri_BaseLayer',
                                ...
                                source: basemap = new ol.source.TileWMS({
                                  url: base_url + '/wms',
                                  params: {'LAYERS': 'APWS:Lowersubansiri_BaseLayer', 'TILED': true},
                                // format : new ol.format.GeoJSON,
                                  serverType: 'geoserver',
                                  // Countries have transparency, so do not fade tiles:
                                  transition: 0
                              ...
                              new ol.layer.Tile(
                                ...
                                baseLayer: false,
                                  source: wshed = new ol.source.TileWMS({
                                    url: base_url + '/wms',
                                    params: {'LAYERS': 'APWS:lower_subansiri_watershed', 'TILED': true},
                                   // format : new ol.format.GeoJSON,
                                    serverType: 'geoserver',
                                    // Countries have transparency, so do not fade tiles:
                                    transition: 0
                              ...
                              new ol.layer.Tile(
                                ...
                                baseLayer: false,
                                  source: circle_layer = new ol.source.TileWMS({
                                    url: base_url + '/wms',
                                    params: {'LAYERS': 'APWS:ls_circle_boundary_01022024', 'TILED': true},
                                   // format : new ol.format.GeoJSON,
                                    serverType: 'geoserver',
                                    // Countries have transparency, so do not fade tiles:
                                    transition: 0
                              ...
                              new ol.layer.Tile(
                                ...
                                baseLayer: false,
                                  source: grid_layer = new ol.source.TileWMS({
                                    url: base_url + '/wms',
                                    params: {'LAYERS': 'APWS:lower_subansiri_grid_10k', 'TILED': true},
                                   // format : new ol.format.GeoJSON,
                                    serverType: 'geoserver',
                                    // Countries have transparency, so do not fade tiles:
                                    transition: 0
    ...
    $.ajax({
      ...
      success: function (data1, status, jqXHR) {
        ...
        if (data1.features.length == 1) {
          ...
          if (layer_title == 'lulc') {
            $("#sidebarcontent").append("<div>" + "<h6>Land Use Land Cover </h6>" + "</div><br>");
          }
...
function getAPReport() {
  ...
  postAPData("../lowersubansiri/apreport.php", data, "POST")
}
...
function convertDMSToDecimcal() {
  ...
  if (arraydms.length==2){
    ...
    map.getView().fit(ol.proj.transformExtent([93.74403198229477 ,27.534637409662977,93.74403198229477 ,27.534637409662977], 'EPSG:4326', map.getView().getProjection()));
    map.getView().setZoom(11.5);
  }
  else {
...
function legend(tlayer) {
  ...
  if (tlayer == 'lower_subansiri_grid_10k') {
    const nolegend = 'no legend';
  }
  else if (tlayer == 'ls_circle_boundary_01022024') {
    const nolegend = 'no legend';
  }
  else if (tlayer == 'Lowersubansiri_BaseLayer') {
    const nolegend = 'no legend';
  }
...
function getVisibleLayerslist() {
  ...
  all_layers.forEach(layer => {
    ...
    if ((layervisability == true) && (layer.getProperties().name == 'lower_subansiri_lulc' ||
      layer.getProperties().name == 'lower_subansiri_slope' ||
      layer.getProperties().name == 'lower_subansiri_lineament' ||
      layer.getProperties().name == 'lower_subansiri_hgeom1_01022024' ||
      layer.getProperties().name == 'lower_subansiri_soil' ||
      layer.getProperties().name == 'lower_subansiri_land_degradation' ||
      layer.getProperties().name == 'lower_subansiri_land_irrigability_01022024' ||
      layer.getProperties().name == 'lower_subansiri_land_capability_01022024' ||
      layer.getProperties().name == 'lower_subansiri_crop_suitability_updated_01022024' ||
      layer.getProperties().name == 'lower_subansiri_action_plan_test_14022024')) {
  ...
  if (toplayer == 'lower_subansiri_lulc') {
    $('#lulc').focus();
    document.getElementById("lulc").click();
  }
  else if (toplayer == 'lower_subansiri_hgeom') {
    $('#hgeom').focus();
    document.getElementById("hgeom").click();
  }
  else if (toplayer == 'lower_subansiri_slope') {
    $('#slope_id').focus();
    document.getElementById("slope_id").click();
  }
  else if (toplayer == 'lower_subansiri_soil') {
    $('#so').focus();
