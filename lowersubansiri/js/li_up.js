             ...
             visible: true
                        ...
                        new ol.layer.Tile(
                              ...
                              new ol.layer.Tile(
                                ...
                                baseLayer: false,
                                  source: grid_source = new ol.source.TileWMS({
                                    url: base_url + '/wms',
...
map.on('singleclick', function (evt) {
  ...
  var url = grid_source.getGetFeatureInfoUrl(
                   ...
                   for (var k in data1.features[index].properties){
                       if (data1.features[index].properties.hasOwnProperty(k)) {
                        ...
                        // console.log(k , data1.features[index].properties[k]);
                         ...
                         Object.entries(li_lables_ls_nam).forEach(([key, value]) => 
                         {
                           
                           if (key == k )
                           {
                             
                             $("#popup-content").append("<div style='font-size:12px;padding-bottom: 10px;'>" + "<strong>" + value +"</strong>" + " : " + data1.features[index].properties[k] +"</div>");
                           }
...
function getVisibleLayerslist() {
  ...
  all_layers.forEach(layer => {
    ...
    if((layervisability == true)  && (layer.getProperties().name == 'lower_subansiri_land_irrigability_01022024')) {
