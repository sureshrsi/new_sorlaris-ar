...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <div class="header_toggle parent">
            ...
            <div class="child ">
                <h5 class="pro-title" style="margin-left:20px;margin-top:1rem;color: #3C457C;font-weight: 600;letter-spacing: 2px;line-height: 18px;">HYDROGEOMAPHOLOGY <br> <span style="margin: 0px;padding: 0px;font-size : 13px;color:#6C6D71">LOWER SUBANSIRI DISTRICT</span>
                </h5>
            </div>
        </div>
