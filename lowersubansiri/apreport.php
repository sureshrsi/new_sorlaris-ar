...
$query = "SELECT ST_Extent(lower_subansiri_soil.the_geom) coordinates FROM public.lower_subansiri_soil where lower_subansiri_soil.id ='$id';";
...
$pointquery = "SELECT ST_ASTEXT(st_centroid(the_geom)) point_coordinates FROM public.lower_subansiri_soil where lower_subansiri_soil.id ='$id';";
...
while ($row_point = pg_fetch_assoc($current_row)) {
 ...
 avl_b_ppm,
 avl_mo_ppm 
 from public.ls_report where soil_code='$soil_code';";
...
<div class="soilinfo">
    ...
    <div class="print-button">
		...
		<button style="background-color:  #3C457C;color:white" type="button" onclick="location.href='lowersubansiri.php'" class="print-buttons btn btn-success">Back</button>
	</div>
